...
import { commonItemNames, tempCommonItemNames } from "../Backend/Utilities/Constants";
import { levelOneItemStats } from "../Backend/Utilities/itemStats";

const options =[]

for(let i = 0; i<tempCommonItemNames.length;i++){
    options.push(levelOneItemStats[tempCommonItemNames[i]])
}
